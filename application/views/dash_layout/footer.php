...
<div class="modal fade" data-bs-backdrop="static" id="cashModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-<?= ($current_cash <= 0) ? 'danger' : 'primary' ?> mb-2">
